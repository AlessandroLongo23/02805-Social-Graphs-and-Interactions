...
def load_community_results(community_file):
...
def create_confusion_matrix(artist_genres, partition, top_n_genres=7, top_n_communities=7):
    """
...
def visualize_confusion_matrix(confusion_matrix, genre_labels, community_labels, 
                               output_file="Week_7/confusion_matrix.png"):
...
def analyze_confusion_matrix(confusion_matrix, genre_labels, community_labels):
...
def save_confusion_matrix_results(confusion_matrix, genre_labels, community_labels, 
                                  output_file="Week_7/confusion_matrix_results.json"):
...
def main():
    ...
    # Create confusion matrix
    confusion_matrix, genre_labels, community_labels = create_confusion_matrix(
        artist_genres, partition, top_n_genres=7, top_n_communities=7
    )
    
    # Visualize
    visualize_confusion_matrix(confusion_matrix, genre_labels, community_labels)
    
    # Analyze
    analyze_confusion_matrix(confusion_matrix, genre_labels, community_labels)
    
    # Save results
    save_confusion_matrix_results(confusion_matrix, genre_labels, community_labels)
