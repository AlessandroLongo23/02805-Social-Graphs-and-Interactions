...
class CommunityDetector():
    ...
    def compare_with_genre_modularity(self, structural_modularity, output_filepath="modularity_results.json"):
    ...
    def visualize_communities(self, G, partition, output_file="community_network_visualization.png", 
    ...
    def visualize_backbone_communities(self, G_backbone, partition, output_file, 
