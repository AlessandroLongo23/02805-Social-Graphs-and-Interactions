...
class GenresExtractor():
    ...
    def analyze_genres(self, artist_genres):
        ...
        plt.tight_layout()
        # plt.savefig('Week 7/top_15_genres_histogram.png', dpi=300, bbox_inches='tight')
        # print(f"\nHistogram saved to: Week 7/top_15_genres_histogram.png")
        plt.show()
...
#     # Save results
#     output_file = "Week 7/artist_genres.json"
#     genres_extractor.save_artist_genres(artist_genres, output_file)
