...
def assign_genres_first(artist_genres):
...
def assign_genres_first_non_rock(artist_genres):
...
def assign_genres_random(artist_genres, seed=42):
...
""")
    ...
    partition_first = assign_genres_first(artist_genres_filtered)
    analyze_partition(partition_first)
    
    print("\nCalculating modularity...")
    modularity_first = calculate_modularity(G_filtered, partition_first)
    ...
    partition_non_rock = assign_genres_first_non_rock(artist_genres_filtered)
    analyze_partition(partition_non_rock)
    
    print("\nCalculating modularity...")
    modularity_non_rock = calculate_modularity(G_filtered, partition_non_rock)
    ...
    partition_random = assign_genres_random(artist_genres_filtered)
    analyze_partition(partition_random)
    
    print("\nCalculating modularity...")
    modularity_random = calculate_modularity(G_filtered, partition_random)
